  ...
  return [
    {
      ...
      label: "Home",
      path: "/",
      metaTitle: "DigitalDev | Easy Digital Marketing",
    ...
    },
    {
      ...
      label: "Packages",
      path: "/packages",
      metaTitle: "Packages & Pricing | DigitalDev",
